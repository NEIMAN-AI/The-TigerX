from Tiger.database import cli
import asyncio

collection = cli["Tiger"]["pmpermit"]

PMPERMIT_MESSAGE = (
    "**𝘄𝗮𝗿𝗻𝗶𝗻𝗴!⚡ɴᴏᴡ ʏᴏᴜʀ ᴡᴏʀᴋ is ᴅᴏɴᴇ, ʏᴏᴜ ʜᴀᴠᴇ ᴍᴇssᴀɢᴇᴅ ᴍᴇ, ɴᴏᴡ ᴡʜᴇɴ ᴍʏ ʙᴏss ᴄᴏᴍᴇs ᴏɴʟɪɴᴇ, ʜᴇ ᴡɪʟʟ ʀᴇᴘʟʏ ᴛᴏ ʏᴏᴜ.⚡.ᴅᴏɴ'ᴛ sᴘᴀᴍ ᴛɪʟʟ ᴛʜᴇɴ ᴏʀ ʏᴏᴜ ᴡɪʟʟ ʙᴇ ʙʟᴏᴄᴋᴇᴅ⚡.  \n\n**"
